...
class DEBmicroTraitKB:
    '''
    Module Name:
    DEBmicroTraitKB

    Module Description:
    A KBase module: DEBmicroTraitKB
This sample module contains one small method that filters contigs.
    ...
    def run_DEBmicroTraitKB(self, ctx, params):
        """
        ...
        #BEGIN run_DEBmicroTraitKB

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_DEBmicroTraitKB function. Params=' + pformat(params))
        ...
        #END run_DEBmicroTraitKB

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_DEBmicroTraitKB return value ' +
